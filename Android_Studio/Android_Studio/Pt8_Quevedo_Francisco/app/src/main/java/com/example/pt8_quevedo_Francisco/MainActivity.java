package com.example.pt8_quevedo_Francisco;
...
public class MainActivity extends AppCompatActivity implements NotaAdapter.OnNotaListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRef = FirebaseDatabase.getInstance("https://pt8-quevedo_Francisco-default-rtdb.firebaseio.com").getReference("notas");
